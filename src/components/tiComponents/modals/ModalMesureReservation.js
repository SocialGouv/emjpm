    ...
    return (
      <Layout show={this.props.show} handleHide={this.props.handleHide}>
        <div style={{ padding: "30px" }}>
          ...
          <br />
          <br />
          {this.props.reservationMandataire.etablissement} recevra une notification par email.Une fois le
          mandat reçu le mandataire pourra valider cette attribution de mesure.
          <br />
          <Form
            schema={schema}
            uiSchema={uiSchema}
