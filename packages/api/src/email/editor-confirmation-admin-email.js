...
Nous avons reçu une nouvelle d'accès à l'api e-MJPM pour les éditeurs de logitiels métier à destination des mandataires et des services de mandataire.

avec le mail suivant: ${email}
avec le nom suivant: ${name}
  
  Veuillez prendre en compte cette demain au plus vite et verifier que tout est ok
