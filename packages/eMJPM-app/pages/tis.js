...
const filterMesures = (mesures, filters) => {
    let filteredMesures = mesures.filter(mesure => {
        return (
            mesure.type.toLowerCase().indexOf(filters.searchType.toLowerCase()) !==
            -1 &&
            (mesure.type.toLowerCase().indexOf(filters.searchTypeIn.toLowerCase()) !==
                -1 &&
                mesure.type
                    .toLowerCase()
                    .indexOf(filters.searchTypePr.toLowerCase()) !== -1 &&
                mesure.type
                    .toLowerCase()
                    .indexOf(filters.searchTypeSe.toLowerCase()) !== -1) &&
            mesure.nom.toLowerCase().indexOf(filters.searchNom.toLowerCase()) !==
            -1 &&
            mesure.ville.toLowerCase().indexOf(filters.searchVille.toLowerCase()) !==
            -1
        );
    });
                                ...
                                <div className="container" style={{ marginTop: "30px" }}>
                                    <div className="row">
                                        <div className="col-6">
                                            ...
                                            <RowModal
                                                label="Contact"
                                                value={currentMandataireModal.referent}
                                            />
                                            <div style={{ textAlign: "left" }}>
                                                {currentMandataireModal.telephone}
                                            </div>
                                            <div style={{ textAlign: "left" }}>
                                        ...
                                        <div className="col-6">
                                            ...
                                            >
                                                <div>
                                                    Mesures en cours :{" "}
                                                    {currentMandataireModal.disponibilite} /{" "}
