          ...
          function () {
            ...
            if (
              ...
              if (document.getElementById("tarteaucitronAlertBig").style.display === "block") {
                heightPosition =
                  document.getElementById("tarteaucitronAlertBig").offsetHeight + "px";
        ...
        window.addEventListener(
          ...
          function () {
            ...
            if (document.getElementById("tarteaucitronCookiesListContainer") !== null) {
              if (
                document.getElementById("tarteaucitronCookiesListContainer").style.display ===
                "block"
              ) {
    ...
    tarteaucitron.addScript(pathToLang, "", function () {
      ...
      tarteaucitron.addScript(pathToServices, "", function () {
        ...
        if (tarteaucitron.parameters.highPrivacy && !tarteaucitron.parameters.AcceptAllCta) {
          html +=
            '<div id="tarteaucitronAlertBig" class="tarteaucitronAlertBig' + orientation + '">';
          ...
          if (tarteaucitron.parameters.highPrivacy) {
            ...
            html +=
              "       " + tarteaucitron.lang.alertBigClick + " " + tarteaucitron.lang.alertBig;
          }
      ...
      if (type === "box") {
        ...
        if (document.getElementById("tarteaucitron") !== null) {
          ...
          if (e[a + "Width"] <= 767) {
            ...
            mainTop =
              (windowInnerHeight - document.getElementById("tarteaucitron").offsetHeight) / 2 - 21;
          }
        ...
        if (document.getElementById("tarteaucitronCookiesListContainer") !== null) {
          ...
          // calculate
          cookiesListHeight = document.getElementById("tarteaucitronCookiesListContainer")
            .offsetHeight;
          cookiesCloseHeight = document.getElementById("tarteaucitronClosePanelCookie")
            .offsetHeight;
