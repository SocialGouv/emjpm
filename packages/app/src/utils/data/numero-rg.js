...
export const MESSAGE_DUPLICATE_NUMERO_RG =
  "Le numéro RG que vous venez de saisir existe déjà sur votre compte eMJPM. Merci de le rectifier. Les numéros RG sont uniques par relation tribunal mandataire.";
