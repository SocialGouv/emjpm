...
import { formatFormInput, parseFormFloat, parseFormInt } from "~/utils/form";
...
export function EnqueteIndividuelInformationsFormationForm(props) {
  const {
    data = {},
    loading = false,
    step,
  ...
  return (
    <form onSubmit={submitForm}>
      ...
      <Heading size={3}>Formation</Heading>
      <Box mt={4}>
