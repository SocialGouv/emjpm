...
import { GET_SDPF } from "./queries";
import { content, subtitle } from "./style";

function SdpfInformations() {
  const { data, error, loading } = useQuery(GET_SDPF, {
...
SdpfInformations.defaultProps = {
  currentAntenne: null,
};

SdpfInformations.propTypes = {
