...
function mapNiveauQualifications(data) {
  return {
    n1: mapNbPreposeNombrePreposesParNiveauQualificationFromForm(
      data ? data.n1 : null
    ),
    n2: mapNbPreposeNombrePreposesParNiveauQualificationFromForm(
      data ? data.n2 : null
    ),
    n3: mapNbPreposeNombrePreposesParNiveauQualificationFromForm(
      data ? data.n3 : null
    ),
    n4: mapNbPreposeNombrePreposesParNiveauQualificationFromForm(
      data ? data.n4 : null
    ),
    n5: mapNbPreposeNombrePreposesParNiveauQualificationFromForm(
      data ? data.n5 : null
    ),
    n6: mapNbPreposeNombrePreposesParNiveauQualificationFromForm(
      data ? data.n6 : null
    ),
  };
}
...
function dataToForm(data) {
  const formData = {
    ...
    niveaux_qualification: mapNiveauQualifications(
      !data ? null : data.niveaux_qualification
    ),
  };
  return formData;
}
