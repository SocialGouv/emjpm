    ...
    <Layout show={show} handleHide={handleHide}>
      <div style={{ textAlign: "center", marginTop: 50 }}>
        ...
        <div style={{ margin: "20px 0", textAlign: "center" }}>
          <Button data-cy="button-modal-reactivate-mesure" onClick={() => onSubmit({id: id, mandataire_id: mandataire_id})}>
            Réactiver la Mesure
          </Button>
        </div>
      </div>
...
const mapDispatchToProps = (dispatch, ownProps) =>
  bindActionCreators({ onSubmit: data => reactivateMesure({ id: data.id, mandataire_id: data.mandataire_id }) }, dispatch);
