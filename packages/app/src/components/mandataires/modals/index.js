export { default as EditMandataire } from "./EditMandataire";
...
export { default as EditServiceSiege } from "./EditServiceSiege";
export { default as AddAntennes } from "./AddAntennes";
