  ...
  public async createEnqueteIndividuelReponse(
    ...
    const query = `
      mutation create_enquete_individuel_reponse($enqueteId: Int!, $mandataireId: Int!) {
        insert_enquete_reponses(objects: {enquete_id: $enqueteId, type: "", enquete_individuel: {data: { mandataire_id: $mandataireId }}}) {
          returning {
            id
            enquete_id
            enquete_individuel {
    ...
    const [enquete_reponse] = data.insert_enquete_reponses.returning;
    return enquete_reponse;
  }
